...
def main():
    ...
    Prints the list of words whose length is strictly greater than the given number.
    Raises AssertionError if the argument count is wrong or the second argument is not numeric.
    """
    try:
        argv = sys.argv[1:]
